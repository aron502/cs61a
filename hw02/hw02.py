...
def product(n, term):
    ...
    162
    """
    return reduce(mul, map(term, range(1, n + 1)))
...
def accumulate(merger, start, n, term):
    ...
    16
    """
    return reduce(merger, map(term, range(1, n + 1)), start)
...
def funception(func1, begin):
    ...
    2
    """
    return lambda end: reduce(mul, map(func1, range(begin, end)), 1)
